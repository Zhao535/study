...
var U = (function () {
    ...
    let array = (function () {
        ...
        let replace = (arr, index, item) => {
            if (isNaN(index) || index > arr.length || !item) {
                return [];
            }
        ...
        return {
            swap, remove, insert, insertLast, unique, replace, getIndex
        }
    })();
    ...
    let price = (() => {
        ...
        return {
            formatPrice, cent2yuan, yuan2cent
        };
