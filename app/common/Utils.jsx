...
let Utils = (function () {
    ...
    let common = (() => {
        ...
        return {
            ...
            xiumiEditor, wxSpider,  byte2status
        };
    })();
    ...
    let adm = (() => {
        ...
        let initPermissions = () => {
            ...
            Utils.adminPermissions = {
                ...
                PRODUCT_LIST: authPermission("PRODUCT_LIST"),

                SCENE_LIST: authPermission("SCENE_LIST"),
                SCENE_EDIT: authPermission("SCENE_EDIT"),

                BRAND_EDIT: authPermission("BRAND_EDIT"),
                BRAND_LIST: authPermission("BRAND_LIST"),

                TEMPLATE_EDIT: authPermission("TEMPLATE_EDIT"),
                TEMPLATE_LIST: authPermission("TEMPLATE_LIST"),

                CATEGORY_EDIT: authPermission("CATEGORY_EDIT"),
                CATEGORY_LIST: authPermission("CATEGORY_LIST"),

                SCENETYPE_EDIT: authPermission("SCENETYPE_EDIT"),
                SCENETYPE_LIST: authPermission("SCENETYPE_LIST"),
            };
        };
